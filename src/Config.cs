...
namespace Vanslate
{
    public static class Config
    {
        ...
        public static bool CreateIfAbsent()
        {
            ...
            {
                Token = "token here",
                Deepl = new BotConfig.DeepL
                {
                    UsePro = false,
                    ApiToken = "deepl free or pro api key"
                },
                Owner = 0,
                Game = "game here",
        ...
        public static BotConfig.DeepL DeepL => _configuration.Deepl;
        ...
        public static HashSet<ulong> VipUsers => _configuration.VipUsers;
        ...
        public record BotConfig
        {
            ...
            {
                [JsonIgnore]
                public string FormattedToken => UsePro
                    ? ApiToken.Replace(":fx", "")
                    : ApiToken.EndsWith(":fx")
                        ? ApiToken
                        : ":fx".Prepend(ApiToken);

                [JsonPropertyName("use_pro_api")]
            ...
            public HashSet<ulong> VipUsers { get; init; }
        }
    }
}