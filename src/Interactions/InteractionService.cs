...
namespace Vanslate.Services
{
    public class InteractionService : IVanslateService
    {
        private readonly DiscordSocketClient _client;
        private readonly IServiceProvider _provider;

        public InteractionService(DiscordSocketClient client, IServiceProvider provider)
        {
            _client = client;
            _provider = provider;
        ...
        public HashSet<ApplicationCommand> AllRegisteredCommands { get; } = new();
        ...
        public async Task InitAsync()
        {
            ...
            _client.InteractionCreated += async interaction =>
            {
                ...
                Executor.Execute(async () =>
                {
                    ...
                    {
                        Logger.Warn(LogSource.Service, "Error occurred when handling the event of some form of Interaction.", e);
                    }
                });
            };
